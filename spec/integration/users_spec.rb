...
RSpec.describe "Users", type: :feature do
  before do
    @user1 = User.create(name: "Donia", photo: "https://via.placeholder.com/150", bio: "I love coding!", posts_counter: 2)
    @user2 = User.create(name: "Jane", photo: "https://via.placeholder.com/150", bio: "I love hiking!", posts_counter: 0)
    # @postone = Post.create(title: 'something', text: 'hello', author: @user1, comments_counter: 0, likes_counter: 0)
    # @posttwo = Post.create(title: 'cool', text: 'world', author: @user1, comments_counter: 0, likes_counter: 0)
  end
